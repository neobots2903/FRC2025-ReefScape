...
public class TunerConstants {
  ...
  private static final Slot0Configs steerGains =
      new Slot0Configs()
          .withKP(30) // 20 was a good value. Drifted though.
          .withKI(0)
          .withKD(0.5) // 0.5
          .withKS(0.1) // 0.1
          .withKV(2.66) // 2.66
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.125).withKI(0).withKD(0).withKS(0.11729).withKV(0.73907);
  ...
  private static final Current kSlipCurrent = Amps.of(120.0); // 45
  ...
  private static final Distance kWheelRadius = Inches.of(2.386); // 4
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(0.16015625);
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(-0.174560546875);
