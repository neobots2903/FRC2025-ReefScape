...
public class IntakeCommands {
    ...
    /**
     * Creates a command that intakes a game piece until it reaches the outtake position.
     * The command runs the intake wheels until the intake limit switch is NOT pressed
     * AND the outtake limit switch IS pressed, indicating the game piece has moved
     * fully to the outtake position.
     * 
    ...
    public static Command intakeGamePiece(EndEffector endEffector) {
        return new Command() {
            ...
            public boolean isFinished() {
                ...
                Logger.recordOutput("Commands/IntakeGamePiece/OuttakeSwitchTriggered", outtakeSwitchTriggered);
            ...
            public void end(boolean interrupted) {
                ...
                endEffector.stop();
                Logger.recordOutput("Commands/IntakeGamePiece", "Ended - " + 
    ...
    /**
     * Creates a command that outtakes a game piece completely.
     * The command runs the outtake wheels until both limit switches are NOT pressed,
     * indicating the game piece has been fully ejected.
     * 
     * @param endEffector The end effector subsystem to use
     * @return The command
     */
    public static Command outtakeGamePiece(EndEffector endEffector) {
        return new Command() {
            ...
            public boolean isFinished() {
                ...
                boolean bothSwitchesClear = !endEffector.isIntakeLimitSwitchTriggered() && 
            ...
            public void end(boolean interrupted) {
                // Stop motors when command ends
                endEffector.stop();
                Logger.recordOutput("Commands/OuttakeGamePiece", "Ended - " + 
                                    (interrupted ? "Interrupted" : "Completed"));
            }
