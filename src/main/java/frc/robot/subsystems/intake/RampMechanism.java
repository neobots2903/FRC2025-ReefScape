...
public class RampMechanism extends SubsystemBase {
    ...
    public RampMechanism() {
        ...
        m_RampMechanism_PivotMotor = new TalonFX(
    ...
    void initMotorConfigurations() {
        ...
        rampMechanismPivotMotorConfig.Slot0.kP =
                RampMechanismConstants.rampMechanismPivot_kP; // An error of 1 rotation results in 2.4 V output
        ...
        rampMechanismPivotMotorConfig.Slot1.kP =
                RampMechanismConstants.rampMechanismPivot_kP1; // An error of 1 rotation results in 60 A output
        ...
        rampMechanismPivotMotorConfig
                .TorqueCurrent
                .withPeakForwardTorqueCurrent(Amps.of(RampMechanismConstants.rampMechanismPivot_stallAmperage))
